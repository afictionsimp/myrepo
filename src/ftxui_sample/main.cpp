...
// configuration step. It creates a namespace called `myrepo`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", myrepo::cmake::project_name, myrepo::cmake::project_version) };
